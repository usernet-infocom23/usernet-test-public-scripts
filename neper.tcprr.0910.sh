...
wget https://github.com/usernet-infocom23/usernet-test-public-scripts/raw/main/neper.tcprr.run.sh -O neper.tcprr.run.sh
chmod +x neper.tcprr.run.sh
bash -l -c './neper.tcprr.run.sh' &
neperspid=$!
