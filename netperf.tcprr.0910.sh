...
ssh usernet-vm4 "netperf -H 172.16.1.103 -p 8864 -D 10 -l 200 -P 0 -t TCP_RR -- -o min_latency,mean_latency,max_latency,stddev_latency,transaction_rate > netperf.result.txt" &
